...
def saveBestfromGenModel(cart, gen):
    cart.brain.save_weights("model6Gen{}.h5".format(gen))

def overwriteAllGenModels(carts):
    for i in range(len(carts)):
        carts[i].brain.save_weights("model6Cart{}.h5".format(i))
...
# Model 6 NN mais complexo 140, score de ataque * 1.5, crossover de 700, numGamesPerCart = 1, selecting 7, saving fixed
